...
class Robot:
    ...
    def __init__(self,
        ...
        self.sensors = list(range(-90, 91, int(180/(num_sensors-1))))
    ...
    def _draw(self, surface):
        ...
        angle_rad = math.radians(self.orientation)
        dx = math.cos(angle_rad) * self.size/3
        dy = math.sin(angle_rad) * self.size/3
    ...
    def gain_sensor_output(self, mask, max_distance = 256, get_directions = False):
